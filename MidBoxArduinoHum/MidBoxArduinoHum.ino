...
void loop() {
    ...
    //moisture 
    int m = int(Light2(analogRead(0)));
    int m1 = int(Light2(analogRead(1)));

    //Analog Photoresistor//
    int lux = int(Light2(analogRead(2)));
    int lux1 = int(Light2(analogRead(3)));
    int lux2 = int(Light2(analogRead(4)));
